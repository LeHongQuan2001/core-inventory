...
const App = function () {
    ...
    const sidebarMainResize = function() {
        ...
        const body = document.querySelector('body'),
            sidebarMainElement = document.querySelector('.sidebar-main'),
        ...
        if(sidebarMainToggler) {
            sidebarMainToggler.forEach(function(toggler) {
                toggler.addEventListener('click', function(e) {
                    e.preventDefault();
                    body.classList.toggle(resizeClass);
    ...
    const sidebarMainToggle = function() {
        ...
        sidebarMainMobileToggler.forEach(function(toggler) {
            toggler.addEventListener('click', function(e) {
                e.preventDefault();
                const result = sidebarMainElement.classList.toggle(sidebarMobileExpandedClass);
                if (result) {
                    sidebarMainElement.className = 'sidebar sidebar-dark sidebar-main sidebar-expand-lg sidebar-mobile-expanded';
                } else {
                    sidebarMainElement.className = 'sidebar sidebar-dark sidebar-main sidebar-expand-lg sidebar-main-resized';
                }
    ...
    const sidebarClick = function() {
        ...
        const sidebarMain = document.querySelector('.sidebar-main'),
            sidebarLinkElements = document.querySelectorAll('.sidebar-main .nav.nav-sidebar a[href]'),
            sidebarMainMobileToggler = document.querySelectorAll('.sidebar-mobile-main-toggle');
        if (sidebarMain && sidebarLinkElements && sidebarMainMobileToggler) {
            sidebarLinkElements.forEach(function(a) {
                ...
                switch (href) {
                    ...
                    default:
                        a.addEventListener('click', function(e) {
                            if (sidebarMain.className.indexOf('sidebar-mobile-expanded') >= 0) {
                                sidebarMainMobileToggler[0].click();
                            }
                        });
                        break;
                }
    ...
    const componentPopover = function() {
        ...
        const elements = document.querySelectorAll('.popover-item');
        if (elements.length) {
            elements.forEach(function(popup) {
                new bootstrap.Popover(popup);
                $(popup).removeClass('popover-item');
            });
        }
    };
    ...
    return {
        ...
        initCore: function() {
            ...
            $('body').addClass('contents');
            $('body').addClass('sidebar-main-resized');
